...
console.log(`Whether a customer has placed an order: ${customer} or ${order}`)
...
let X:boolean = true
let Y:Boolean = false
console.log(`Person's marital status: ${X} or ${Y}`)
...
let blood:string = 'A'
console.log(`Person's blood type: ${blood}`)
...
console.log(`Number of employees in a company: ${employee}`)

//16.Time of an event: 2:30 PM
//const eventTime: Date = new Date();
let time:string = "2:30 PM"
//eventTime.setHours(14, 30);
//console.log('${time} eventTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })')
...
let colour:string = "Brown"
console.log(`Person's eye color: ${colour}`)

//19.Person's birthplace: "New York City"
let place:string = "New York City"
console.log(`Person's birthplace: ${place}`)
